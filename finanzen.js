...
function renderFinanzenTabInner(containerId = "app") {
    ...
    app.innerHTML = `
        ...
        <div class="mb-3 flex flex-col sm:flex-row sm:justify-between items-start gap-2">
            ...
            <button id="add-trans-btn" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-lg text-xs flex items-center gap-1.5 font-semibold transition shadow self-start">
